...
const DeluxePage = () => {
  const images = [gallery1, deluxe, deluxe, deluxe];
    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 text-center text-white">
          <h1 className="text-3xl md:text-4xl font-semibold mb-2">Deluxe Room</h1>
          <p className="text-sm">Home / Deluxe Room</p>
        </div>
      </div>

      <div className="flex flex-col md:flex-row p-6 bg-[#f0fdfa] min-h-screen">
        <div className="md:w-2/3 w-full space-y-10 pr-0 md:pr-6">
          ...
          <section>
            ...
            Experience luxury in our deluxe room featuring plush interiors, smart TV, mini fridge, premium toiletries, and high-speed Wi-Fi.         </p>
          </section>
        ...
        <div className="md:w-1/3 w-full md:sticky md:top-24 mt-10 md:mt-0 bg-gray-100 flex justify-center">
          ...
          >
            ...
            <h2 className="text-green-600 text-2xl font-bold mb-2">₹1500</h2>
