    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 text-center text-white">
          <h1 className="text-3xl md:text-4xl font-semibold mb-2">Luxury Room</h1>
          <p className="text-sm">Home / Luxury Room</p>
        </div>
      </div>

      <div className="flex flex-col md:flex-row p-6 bg-[#f0fdfa] min-h-[60vh]">
        <div className="md:w-2/3 w-full space-y-10 pr-0 md:pr-6">
          <img
            src={mainImage}
            alt="Main Room"
            className="rounded-2xl w-full h-81 object-cover shadow-md"
          />
            ...
            {images.map((img, idx) => (
              <div
                ...
                className={`w-24 h-20 rounded-md overflow-hidden cursor-pointer border-2 ${
                  mainImage === img ? "border-orange-400" : "border-transparent"
                }`}
              >
                <img
                  src={img}
          ...
          <section>
            <h1 className="text-3xl font-bold text-gray-800 mb-4">Hotel Princeinn Noida is waiting for you!</h1>
            <p className="text-gray-600 text-lg leading-relaxed">
            Relax in our Standard Room, a perfect blend of simplicity and comfort for travelers seeking convenience at a great value. This room is thoughtfully designed to meet your essential needs during your stay.            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">Amenity</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {amenities.map((item, idx) => (
                <div
                  key={idx}
                  className="bg-white rounded-xl shadow-md flex flex-col items-center p-6 text-center hover:shadow-lg transition"
                >
        ...
        <div className="md:w-1/3 w-full md:sticky md:top-24 mt-10 md:mt-0 bg-gray-100 flex justify-center">
          ...
          >
            ...
            <h2 className="text-green-600 text-2xl font-bold mb-2">₹1900</h2>
